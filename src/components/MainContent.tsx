          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {featuresLoading ? (
              ...
              features?.map((feature, index) => (
                ...
                >
                  <CardContent className="p-4 text-center scale-75">
                    <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-foreground mb-3">
                      {(() => {
                        const IconComponent = getIconComponent(feature.icon);
                        return <IconComponent className="w-6 h-6 text-background" />;
                      })()}
                    </div>
